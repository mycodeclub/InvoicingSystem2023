...
namespace InvoicingSystem.Controllers
{
    public class InvoicesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,InvoiceNumber")] Invoice invoice)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("ID,InvoiceNumber")] Invoice invoice)
        {
            if (id != invoice.ID)
            {
                return NotFound();
